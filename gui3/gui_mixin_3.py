#clone and spawn
#clone: quit, all quit
#spawn: quit, only quit current

from tkinter import *
from tkinter.messagebox import *
from tkinter.filedialog import *
from text_11 import ScrolledText # or tkinter.scrolledtext
from launchmode_2 import PortableLauncher, System # or use multiprocessing
...
if __name__ == '__main__':
    class TestMixin(GuiMixin, Frame): # standalone test
        ...
        def other(self):
            self.spawn('gui_mixin_3.py') # spawn self as separate process
