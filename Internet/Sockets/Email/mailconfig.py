...
popservername = 'pop3.live.com'
popusername   = 'user@hotmail.com'
...
poppasswdfile  = r'D:\\T\\Temp\\pymailgui.txt'      # set to '' to be asked
...
savemailfile   = r'D:\\T\\Temp'       # not used in PyMailGUI: dialog
